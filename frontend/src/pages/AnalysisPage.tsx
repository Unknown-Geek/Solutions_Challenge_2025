...
export default function AnalysisPage() {
  ...
  const checkServerHealth = async () => {
    try {
      ...
      setError("Server connection issue detected. Data may not be up-to-date.");
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Analyze environmental data and reforestation potential across
              different regions. Compare metrics and identify trends to make
              informed decisions.
            </p>
          </div>
          ...
          {/* Always render the dashboard component rather than conditionally */}
