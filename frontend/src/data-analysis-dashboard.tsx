        ...
        <TabsContent value="climate">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Temperature and precipitation patterns for the selected region</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="suitability">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Comparison of overall suitability scores across top regions</CardDescription>
            </CardHeader>
            <CardContent className="h-[400px]">
              <BarChart
        ...
        <TabsContent value="impact">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Breakdown of potential ecological benefits from reforestation</CardDescription>
            </CardHeader>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Breakdown of soil types and their suitability for reforestation</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tree species most suitable for the selected region</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Native hardwood with excellent carbon sequestration properties
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Provides habitat for wildlife and sustainable income for communities
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Fast-growing with extensive root systems for soil stabilization
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Economically valuable and adaptable to various soil conditions
                  </p>
                </div>
              </div>
            </div>
